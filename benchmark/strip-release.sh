...
git rm -q \
  ...
  benchmark/phases.jl benchmark/compare_phases.jl benchmark/alloc_phases.jl \
...
grep -rn -e "suite.jl" -e "large-scale-roadmap" -e "hsd-design" -e "baselines" -e "moi_model" \
        -e "sumnorms" -e "phases.jl" -e "alloc_phases" -e "review_benchmark" -e "harness_tests" -e "benchmark/results" \
